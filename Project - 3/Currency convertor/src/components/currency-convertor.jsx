...
const CurrencyConverter = (props) => {
  ...
  return (
    <div className={`max-w-xl mx-auto my-10 p-5 ${props.mode === 'light'?'bg-[#ffffff70]':'bg-[#00000070]'} rounded-lg shadow-md`}>
      <h2 className={`mb-5 text-2xl font-semibold ${props.mode === 'light'?'text-slate-900':'text-white'}`}>Currency Converter</h2>
